...
Open the document containing your commerce block in the [Document Authoring tool](/merchants/quick-start/document-authoring/) or [Visual Editor](/merchants/quick-start/visual-editor/).
